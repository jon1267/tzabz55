        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Начальник </div>
                            ...
                            @foreach($parents as $parent)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('table.child.parent', ['id'=>$parent->id]) }}" class="btn btn-success btn-sm" title="Убрать таблицу ниже"> <i class="fa fa-users" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
            ...
            <div class="children panel panel-default">
                <div class="panel-heading">Подчиненные </div>
                        ...
                        <table class="table table-bordered table-striped ">
                            ...
                            @foreach($depends as $depend)
                                <tr >
                                    ...
                                    <td>{{ $depend->name }}</td>
                                    <td>{{ $depend->employed_at->format('Y-m-d') }}</td>
                                    <td>{{ $depend->salary }}</td>
                                    <td>{{ $depend->position->position }}</td>
                                    <td>
                                        <a href="" class="btn btn-primary btn-sm" title="Подчиненные подразделения"> <i class="fa fa-sitemap" aria-hidden="true"></i> </a>
                                        <a href="{{ route('table.child.parent',['id'=>$depend->id]) }}" class="btn btn-primary btn-sm" title="Подчиненные сотрудники"> <i class="fa fa-users" aria-hidden="true"></i> </a>
                                    </td>
                                </tr>
                                {{--<a href="{{ route('tree.child.parent', ['id'=>$parent->parent_id]) }}"
                                   class="list-group-item list-group-item-info">
